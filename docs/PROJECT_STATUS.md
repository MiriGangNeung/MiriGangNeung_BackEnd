...
- **CI** (2026-09-14): `.github/workflows/ci.yml` — PR마다 `./gradlew build`와 이미지 빌드를 돌리고, main 병합 시 `ghcr.io/mirigangneung/mirigangneung_backend`에 `latest`·`sha-<커밋>` 이미지를 게시한다.
